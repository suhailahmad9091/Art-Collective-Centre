...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="color: red; font-weight: bold">Manage Buyer</h1>
            <br />
            <a style="padding: 5px 20px" class="btn btn-success" href="./add_buyer.jsp?a_id=<%=a_id%>"
               >Add Buyer</a
            >
            <br />
            <br />
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./update_buyer.jsp?b_id=<%=rs.getString(1)%>&a_id=<%=a_id%>"
                               ><i class="fa fa-edit" aria-hidden="true"></i
                                ></a>
                            &nbsp;
                            <a href="./delete_buyer.jsp?b_id=<%=rs.getString(1)%>&a_id=<%=a_id%>"
                               ><i
                                    style="color: red"
