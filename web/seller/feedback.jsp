...
<html>
    ...
    <div class="container">
        ...
        <br />
        <a style="padding: 5px 20px" class="btn btn-success" href="./add_feedback.jsp?s_id=<%=s_id%>"
           >Add Feedback</a
        >
        <br />
        <br />
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <%
                    ...
                    PreparedStatement pst = con.prepareStatement("select b_name, f_date, f_text from feedback f, buyer b where b.b_id = f.b_id and f.s_id = "+s_id);
