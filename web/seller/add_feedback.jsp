...
<%
    if (request.getParameter("submit") != null) {
        ...
        PreparedStatement pst = con.prepareStatement("select b_id from buyer where b_name=?");
        pst.setString(1, buyer_name);
...
<script>
    ...
    window.location = "./feedback.jsp?s_id=<%=s_id%>";
</script>
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <select name="buyer_name" id="buyer_name" required>
                                <%
                                    Connection con = ConnectionProvider.getCon();
                                    PreparedStatement pst = con.prepareStatement("select b_name from buyer order by b_name");
                                    ResultSet rs = pst.executeQuery();
