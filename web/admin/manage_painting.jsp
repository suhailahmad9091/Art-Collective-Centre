...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="color: red; font-weight: bold">Manage Painting</h1>
            <br />
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="./update_painting.jsp?p_id=<%=rs.getString(1)%>&a_id=<%=a_id%>"
                           ><i class="fa fa-edit" aria-hidden="true"></i
                            ></a>
                        &nbsp;
                        <a href="./delete_painting.jsp?p_id=<%=rs.getString(1)%>&a_id=<%=a_id%>"
                           ><i
                                style="color: red"
